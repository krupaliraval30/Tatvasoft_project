            ...
            mauth.createUserWithEmailAndPassword(email1,pwd1).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull  Task<AuthResult> task) {
                    if(task.isSuccessful())
                    {
                        ...
                        Intent homepage=new Intent(create_account.this,homepage.class);
                    ...
                    {
                        Toast.makeText(create_account.this, "Registration Error"+ task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
